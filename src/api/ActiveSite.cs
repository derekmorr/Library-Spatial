...
{
    /// <summary>
    /// An individual active site on a landscape.
    /// </summary>
    public struct ActiveSite
    {
        ...
        /// <summary>
        /// Converts an active site to a site.
        /// </summary>
        public static implicit operator Site(ActiveSite activeSite)
        {
            if (activeSite)
                return new Site(activeSite.Landscape,
                                activeSite.Location,
                                activeSite.DataIndex);
            else
                return new Site();
        }
        ...
        /// <summary>
        /// Converts a site to an active site.
        /// </summary>
        /// <exception cref="System.InvalidCastException">
        /// The site is inactive.
        /// </exception>
        public static explicit operator ActiveSite(Site site)
        {
            if (site.IsActive)
                return new ActiveSite(site.Landscape,
                                      site.Location,
                                      site.DataIndex);
            throw new System.InvalidCastException("site is inactive");
        }
        ...
        /// </summary>
        public static bool operator ==(ActiveSite site1,
                                       ActiveSite site2)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            if (obj == null || GetType() != obj.GetType())
                return false;
            ActiveSite site = (ActiveSite)obj;
            return this == site;
        }
